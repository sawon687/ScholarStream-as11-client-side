        ...
        <div className="navbar-end">
          {!user ? (
            <>
              <Link
                to="/Login"
                className="px-6 py-2 rounded-full border-2 border-indigo-600 text-indigo-600 font-semibold hover:bg-indigo-600 hover:text-white transition-all duration-300"
              >
                Log in
              </Link>
