    ...
    <>
      <li>
        <NavLink
          to="/"
          className={({ isActive }) =>
            `md:px-4 px-18 py-2 rounded-full md:mr-0 mr-25 text-center transition-all duration-200 mx-1
            ${
              isActive
      ...
      <li>
        <NavLink
          to="/allScholarship"
          className={({ isActive }) =>
            `px-4 py-2    px-18 py-2 rounded-full md:mr-0 mr-25 text-centerrounded-full text-center transition-all duration-200 mx-1
            ${
              isActive
                ? "bg-gradient-to-r from-indigo-600 to-purple-600 text-white"
                : "text-gray-700 hover:text-white hover:bg-gradient-to-r hover:from-indigo-600 hover:to-purple-600"
